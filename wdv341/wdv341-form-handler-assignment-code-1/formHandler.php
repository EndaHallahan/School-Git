...
//Model-Controller Area.  The PHP processing code goes in this area. 
	...
	$inVehicle = $_POST["vehicle"];
	$inOnline = $_POST["online"];
	$inBlended = $_POST["blended"];
	$inSchooling = $_POST["schooling"];
	$inHoneypot = $_POST["honeypot"];

	if(!empty($inHoneypot)) {
      $tableBody = "<h1>BAD INPUT!</h1>"
    }
...
<p>Vehicle: <?php echo $inVehicle; ?></p>
<p>Online: <?php echo $inOnline; ?></p>
<p>Blended: <?php echo $inBlended; ?></p>
<p>Schooling: <?php echo $inSchooling; ?></p>
<p>Honeypot: <?php echo $inHoneypot; ?></p>
